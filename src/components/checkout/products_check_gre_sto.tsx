...
export const ProductsCheck = () => {
  ...
  return (
    <>
      <div className="grid grid-cols-8 px-6 sm:grid-cols-10">
        <div className="col-span-12 overflow-hidden rounded-xl bg-gray-50  bg-opacity-80 px-8 py-8 shadow">
          <div className="">
              ...
              {checkProduct.data.map((element) => (
                <div className="flex flex-col rounded-lg bg-white sm:flex-row">
                  ...
                  <div className="flex w-full flex-col px-4 py-4">
                    <span className="font-semibold">{element.nombre}</span>

                    <p className="mt-auto text-lg font-bold">
                      ₡ {element.precio - element.precio * (element.desc / 100)}
                    </p>
                  </div>
                </div>
              ))}
            ...
            <form className="mt-5 grid gap-6">
              <div className="relative">
                ...
                />
                <span className="peer-checked:border-[#9C5478] absolute right-4 top-1/2 box-content block h-3 w-3 -translate-y-1/2 rounded-full border-8 border-gray-300 bg-white"></span>
                <label
