  ...
  return (
    ...
    <div className="hero-content text-center text-neutral-content">
      <div className="max-w-md">
        <h1 className="mb-5 text-5xl font-bold text-font-nav sm:text-7xl"style={{fontFamily:'Dancing Script,cursive'}}>Bienvenidos a Grema Store</h1>
        <p className="mb-5 text-2xl text-font-nav sm:text-3xl">Haz que tus recuerdos duren para siempre con nuestra bisuteria elegante y hermosa.</p>
