...
export const AlertZero = ({
  ...
  const handleGoToStore = () => {
    ...
    loading(true);
    dispatch(alert_type({ type: "" }));
    navigate("/store/"+pagination); // Navegar a la tienda
  };
  ...
  return (
    <>
      <div className="m-10 flex max-w-lg flex-col items-center px-8 py-10 text-gray-800 ">
        ...
        <p className="mt-4 text-center text-xl font-bold">La cantidad es incorrecta</p>
        <p className="mt-2 text-center text-lg">Debes cambiarla</p>
