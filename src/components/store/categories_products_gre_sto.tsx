...
export const Categories = () => {
  return (
    <>
      <div className="mt-10  grid grid-cols-2 gap-x-5 gap-y-5 sm:grid-cols-5 md:grid-cols-5  lg:grid-cols-5  lg:gap-x-2  xl:gap-x-3 xl:grid-cols-5">
        <div className="justify-self-end sm:justify-self-center">
          <LazyLoadImage
            ...
            style={{ border: "solid 3px", borderColor: "#9B5176" }}
          />
        </div>
        <div className="sm:justify-self-center">
          <LazyLoadImage
            src="https://grema-store-frontend.vercel.app/images/Historia frase emprendedores Degradado Rosa (2).gif"
            className="w-24 h-12  shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl"
            style={{ border: "solid 3px", borderColor: "#9B5176" }}
          />
        </div>
        <div className="justify-self-end sm:justify-self-center">
      ...
      <div className="mt-2  grid grid-cols-1 justify-items-center gap-x-1 gap-y-1 sm:grid-cols-1 sm:gap-x-1 md:grid-cols-1 md:gap-x-3  lg:grid-cols-5  lg:gap-x-2  xl:gap-x-3 xl:grid-cols-5">
