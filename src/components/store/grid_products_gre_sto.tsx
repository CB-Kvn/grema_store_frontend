...
//       <div
//         className="justify-items-center grid grid-cols-1 gap-x-5 gap-y-5 xxxs:grid-cols-2 xxxs:gap-x-2 xxs:grid-cols-2 xxs:gap-x-5
//     sm:grid-cols-3 sm:gap-x-6 xmd:grid-cols-3 xmd:gap-x-5  md:grid-cols-4 md:gap-x-5  lg:grid-cols-4 lg:gap-x-14
//     xl:grid-cols-4 xl:gap-x-14 "
//       >
//         {products.map((element) => (
//           <div className="relative">
//             <div
//               className="w-44 xxxs:w-44 xxs:w-56 sm:w-52  xmd:w-56 md:w-44 lg:w-48 xl:w-56  bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl"
//               style={{ backgroundColor: "#f7f7f7" }}
//             >
//               <LazyLoadImage
//                 src="https://grema-store-frontend.vercel.app/images/WhatsApp Image 2024-02-01 at 1.28.10 PM.jpeg"
//                 alt="Product"
//                 className=" w-44 xxxs:w-44 xxs:w-56 sm:w-52 xmd:w-56 md:w-44 lg:w-48 xl:w-56 object-cover rounded-t-xl"
//                 onClick={() => handleModalProduct(element)}
//               />
//               <div className="w-44 mt-3 xxxs:w-44 xxs:w-56 sm:w-52 xmd:w-56  md:w-44 lg:w-48 xl:w-56  ml-1">
//                 <p
