          ...
          <div className="w-72 sm:w-64 md:w-60 lg:w-60 xl:w-64 bg-white shadow-md rounded-xl duration-500 hover:scale-105 hover:shadow-xl">
            <a href="#">
              <img
                ...
                alt="Product"
                className="h-72 w-72 sm:h-72 sm:w-64  md:h-64 md:w-60 lg:h-72 lg:w-64 xl:w-64 xl:h-80 object-cover rounded-t-xl"
                onClick={() => handleModalProduct()}
              />
              <div className="px-4 pt-2 w-72 sm:w-64 md:40 lg:w-60 xl:w-64">
                <p
                ...
                <div className="flex items-center justify-between">
                  <div className="inline-flex">
                    <p
                      className="text-lg font-semibold  cursor-auto my-2"
                      style={{ color: "rgb(194, 167, 141)" }}
                    >
                      {e.price}
                    </p>
                    <p
                      className="oper text-sm mt-revert  cursor-auto"
                      style={{ color: "rgb(194, 167, 141)" }}
                    >
                      {e.price}
                    </p>
                    ...
                    >
                      {love.some((item) => item.id === e.id) ? (
                        ...
                        <svg
                          ...
                          onClick={(event) => {
                            event.preventDefault(), handleUnLovinArticle(e.id);
                          }}
                          version="1.1"
                          xmlns="http://www.w3.org/2000/svg"
                        >
