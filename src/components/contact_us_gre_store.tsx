    ...
    <section className="mb-32">
        ...
        <div className="flex justify-center">
            <div className="text-center md:max-w-xl lg:max-w-3xl" >
                <h2 className="text-footer mb-12 px-6 text-4xl font-bold sm:text-6xl " style={{fontFamily:'Dancing Script,cursive'}} >
                    Contact us
                </h2>
            </div>
        </div>
        ...
        <div className="flex flex-wrap">
            ...
            <form className="mb-12 w-full shrink-0 grow-0 basis-auto md:px-3 lg:mb-0 lg:w-5/12 lg:px-6">
                ...
                <div className="mb-3 w-full">
                    <label className="block font-medium mb-[2px] text-footer" htmlFor="exampleInput90">
                            Name
                    </label>
                ...
                <button type="button"
                        className="mb-6 inline-block w-full rounded bg-nav px-6 py-2.5 font-medium uppercase leading-normal text-white hover:shadow-md hover:bg-teal-500">
                        Send
                </button>
                ...
                <div className="flex flex-wrap">
                    ...
                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
                        <div className="align-start flex">
                            ...
                            <div className="ml-6 grow">
                                <p className="mb-2 font-bold text-footer">Press</p>
                                <p className="text-neutral-500 ">
                                    press@example.com
                                </p>
                                <p className="text-neutral-500 ">
