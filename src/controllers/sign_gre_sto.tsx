...
import { loader_visible, password_verify, toast_visible} from "../redux/reducers_slices/handler_gre_sto_slice";
...
export const SignController = async (data:UsersService,dispatch:any,location:string) =>{
    try {
